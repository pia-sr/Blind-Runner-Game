 ...
 *
 * This code was slightly modified to accommodate the specific patterns for the runner game
 */
...
public class naviBeltController {
    ...
    //Function to start a vibration with a given intensity at a given channel
    //for the game only 3 vibro motors are used, thus the channel index indicates the position of the vibration
    ...
    //Function to start a pulse pattern with the given parameters
    //for the game only 3 vibro motors are used, thus the channel index indicates the position of the vibration
    public void startPulse(Integer intensity, int duration, int period, int continuous, Integer channelIndex ){
     ...
     //Three different variations of scheduleOrSendVibrationCommand depending on the vibration the game needs
    ...
    //Sends the vibration command to the belt, so the given vibration can start
